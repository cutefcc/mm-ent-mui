...
const os = require("os");
const happyThreadPoll = HappyPack.ThreadPool({ size: os.cpus().length }); //开辟一个线程池
...
let webpackConfig = {
  ...
  module: {
    rules: [
      ...
      //   use: [
      //     {
      //       loader: path.join(__dirname, 'loader/myMdLoader.js'),
      //       options: {
      //           item: "myMdLoader"
      //       },
      //     }
  ...
  resolve: {
    alias: {
      ...
      "mm-ent-ui": path.resolve(__dirname, "./src/webapp/mmEntUi"),
    },
  },
};
